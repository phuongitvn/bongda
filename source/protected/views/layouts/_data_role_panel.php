...
<div data-role="panel" data-position-fixed="true" data-display="push" data-theme="g" id="nav-panel">
		...
		<ul data-role="listview">
            <li data-icon="delete"><a href="<?php echo Yii::app()->createUrl('/site/index');?>" data-rel="close"><img width="144" src="/images/logo.png" /></a></li>
                ...
                <li><a href="<?php echo Yii::app()->createUrl('/post/index', array('url_key'=>'bong-da-phap'))?>">Bóng đá Pháp</a></li>
                ...
                <li><a href="<?php echo Yii::app()->createUrl('/post/index', array('url_key'=>'tin-chuyen-nhuong-cau-thu'))?>">Tin Chuyển Nhượng</a></li>
